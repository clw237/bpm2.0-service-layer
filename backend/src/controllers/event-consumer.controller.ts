    ...
    try {
      switch (data.type) {
        case 'CAMPAIGN_LAUNCHED':
          await this.campaignService.launchCampaignWorkflow(data);
          break;
        case 'PARTICIPANTS_ADDED':
          await this.campaignService.addParticipants(data);
          break;
        case 'PARTICIPANT_COMPLETED':
          await this.participantStatusService.updateParticipantAssessment(data);
          break;
        case 'RATER_ASSESSMENT_COMPLETED':
          await this.participantStatusService.updateRaterAssessment(data);
          break;
        default:
