...
WORKFLOW_DOMAIN="https://workflow-orchestration-api.apps.app01.prd-use1.int-kfone.com"
CONNECT_RMQ_SCHEDULER_ROUTING_KEY= "scheduler.users.listen"
CONNECT_RMQ_EMAIL_STATUS_ROUTING_KEY = "email.status.update"
SES_TEST_EMAIL = ""
SES_CONFIGURATION_SET = "kfone-prd-use1-configsets-connect-email"
SES_FROM_EMAIL = "noreply@kornferrytalent.com"
LOG_TO_DB = "yes"
LOGIN_URL = "https://home.kornferrytalent.com"
